...
export const MELAKARTA_SEED_DATA: MelakartaSeed[] = [
  ...
  { number: 65, name: "Mechakalyani", chakra: "Rudra", arohana: "S R3 G3 M2 P D2 N3 S'", avarohana: "S' N3 D2 P M2 G3 R3 S", description: "The 66th Melakarta raga, commonly known as Kalyani. One of the most popular ragas.", metadata: { western_equivalent: "Lydian mode", popular_janyas: ["Yaman Kalyan", "Hamsanandi"] } },
  ...
  { number: 71, name: "Kosalam", chakra: "Aditya", arohana: "S R1 G2 M3 P D2 N3 S'", avarohana: "S' N2 D2 P M3 G2 R1 S", description: "The 71st Melakarta raga." },
