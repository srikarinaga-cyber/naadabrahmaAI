...
export function TanpuraDroidStandalonePlayer() {
  ...
  const toggleAllTanpuras = () => {
    if (isTanpura1Active || isTanpura2Active) {
  ...
  return (
    <div className="glass-panel traditional-glow rounded-3xl border border-swara-gold/25 bg-card p-6 md:p-8 space-y-6 shadow-sm">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-border pb-4 gap-4">
        ...
        >
          {isTanpura1Active || isTanpura2Active ? (
            ...
            <>
              <Play className="size-4 fill-current" /> Start Tanpura Droid (SA PA SA)
            </>
          )}
        </Button>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 rounded-2xl bg-muted/40 p-4 border border-border/50">
          ...
          <div>
            <label className="block text-xs font-semibold text-foreground mb-1">
              Adhara Shadja Sruthi (Base Pitch Key):
            </label>
            <select
      ...
      {/* Tanpura Droid SA PA SA String Strumming Visualizer */}
      {(isTanpura1Active || isTanpura2Active) && (
        <div className="rounded-2xl border border-swara-gold/25 bg-kumkum/5 p-4 flex items-center justify-between text-xs animate-in fade-in duration-200">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-foreground">SA-PA-SA String Strumming Visualizer:</span>
          </div>
        ...
        <div className="glass-panel rounded-2xl border border-swara-gold/20 bg-card p-5 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h4 className="font-serif text-sm font-bold text-kumkum">Tanpura 1 (Left Channel)</h4>
                <p className="text-[10px] text-muted-foreground">Primary SA-PA-SA Acoustic Drone</p>
              </div>
            </div>
        ...
        <div className="glass-panel rounded-2xl border border-swara-gold/20 bg-card p-5 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="text-lg">🪕</span>
              <div>
                <h4 className="font-serif text-sm font-bold text-kumkum">Tanpura 2 (Right Channel)</h4>
                <p className="text-[10px] text-muted-foreground">Stereo Interplay Acoustic Drone</p>
              </div>
            </div>
