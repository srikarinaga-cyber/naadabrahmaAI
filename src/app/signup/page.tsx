...
import { Music, ArrowLeft, GraduationCap } from "lucide-react";
      ...
      <div className="mx-auto w-full max-w-md my-auto z-10 pt-6 pb-6">
        <div className="glass-panel traditional-glow rounded-3xl border border-swara-gold/30 bg-card/90 p-8 md:p-10 shadow-xl backdrop-blur-md">
          <div className="text-center mb-6">
            ...
            <h1 className="font-serif text-3xl font-bold text-kumkum">Create Account</h1>
            <p className="text-xs text-muted-foreground mt-2 leading-relaxed">
              Join Naadabrahma AI to master Carnatic music theory, track study streaks, and chat with AI Guru.
            </p>
          </div>
