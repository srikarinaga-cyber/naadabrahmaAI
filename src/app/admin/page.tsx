      ...
      <main className="mx-auto max-w-2xl px-6 py-24 text-center">
        <div className="glass-panel traditional-glow rounded-3xl border border-swara-gold/15 p-10 md:p-12">
          <div className="mx-auto mb-6 flex size-16 items-center justify-center rounded-2xl bg-kumkum/10 ring-1 ring-swara-gold/30">
            <Shield className="size-8 text-kumkum" />
          </div>
          ...
          <p className="text-muted-foreground leading-relaxed mb-8">
            The Academy Administration Portal is currently under development. This space will allow academy directors and platform administrators to customize content catalogs, configure metadata, and run system health checks.
          </p>
